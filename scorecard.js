...
async function exportToPDF() {
  ...
  pdf.setFontSize(14);
  pdf.text(titleSub, pageWidth / 2, pageHeight / 2 + 10, { align: "center" });

  // ✅ after cover page, start new page for first category
  pdf.addPage();
  let yOffset = 30;
  ...
  const chartConfigs = [
    ...
    },
    {
      ...
      header: "First Payment Timeliness",
  ...
  for (let i = 0; i < chartConfigs.length; i++) {
    ...
    if (currentCategory !== cfg.category) {
      // Always page break between categories
